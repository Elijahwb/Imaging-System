      ...
      <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse  justify-content-between top-header mt-5 ml-0">
          ...
          <ul class="navbar-nav header-right">
            ...
            <li class="nav-item dropdown notification_dropdown">
              <a class="nav-link bell bell-link"
               href="#"
            ...
            <li class="nav-item dropdown header-profile">
              ...
              >
                <div class="header-info">
                  <span class="text-black">{{ user.first_name }}.</span>
              ...
              >
                <a href="/doctor/profile" class="dropdown-item ai-icon">
                  <i class="fa fa-user"></i>
                  <span class="ml-2">Profile </span>
                </a>

                <div @click="this.$store.dispatch('logout')" class="dropdown-item ai-icon logout">
